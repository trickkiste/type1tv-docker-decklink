...
RUN apt-get update && \
    ...
    cd /tmp && tar xvfz /tmp/Blackmagic_Desktop_Video_Linux_10.1.1.tar.gz && dpkg -i /tmp/DesktopVideo_10.1.1/deb/amd64/desktopvideo_10.1.1a26_amd64.deb && \
    ...
    rm -rf /var/lib/apt/lists/* && apt-get autoclean && apt-get clean && apt-get autoremove
